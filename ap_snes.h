...
#define TILE_ATTR_WALK 0x01 // Walkable
#define TILE_ATTR_SWIM 0x02 // Swim-able
#define TILE_ATTR_DOOR 0x04 // Door or other transition
#define TILE_ATTR_ITEM 0x08 // Item (chest, or something under a pot)
#define TILE_ATTR_LFT0 0x10 // Can lift with no power ups
#define TILE_ATTR_LFT1 0x20 // Can lift with power glove
#define TILE_ATTR_LFT2 0x40 // Can lift with titans mitts

static const uint8_t ap_tile_attrs[256] = {
    [0x00] = TILE_ATTR_WALK,
    [0x01] = 0,
    [0x02] = 0,
